...
const TravelerPassengersAdmin = () => {
  ...
  const req = async () => {
    setLoading(true);
    let status;
    await fetch('https://dolphin-app-d4vhp.ondigitalocean.app/api/travelers/' + travelerId + '/passengers', {
      method: 'GET',
      headers: {
...
export default TravelerPassengersAdmin